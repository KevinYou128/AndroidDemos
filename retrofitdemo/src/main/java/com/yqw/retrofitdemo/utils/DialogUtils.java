...
public class DialogUtils {
    ...
    public static AlertDialog showAlert(Context context, String title, String message, String confirmButton, DialogInterface.OnClickListener confirmButtonClickListener, String centerButton, DialogInterface.OnClickListener centerButtonClickListener, String cancelButton, DialogInterface.OnClickListener cancelButtonClickListener, DialogInterface.OnShowListener onShowListener, boolean cancelable, DialogInterface.OnCancelListener onCancelListener, DialogInterface.OnDismissListener onDismissListener) {
        ...
        alertDialog.setCanceledOnTouchOutside(false);//点击域外不消失
        alertDialog.show();
        return alertDialog;
    }
    ...
    public static AlertDialog showAlert(Context context, String message, DialogInterface.OnClickListener confirmButtonClickListener) {
        return showAlert(context, "提示", message, "确定",
                confirmButtonClickListener, null, null, "取消",
     ...
     * @return 对话框
     */
    public static AlertDialog showAlertConfirm(Context context, String message, DialogInterface.OnClickListener confirmButtonClickListener) {
        return showAlert(context, "提示", message, "确定",
     ...
     * @return 对话框
     */
    public static AlertDialog showAlertCancleConfirm(Context context, String message, DialogInterface.OnClickListener confirmButtonClickListener, DialogInterface.OnClickListener cancelButtonClickListener) {
        return showAlert(context, "提示", message, "确定",
                confirmButtonClickListener, null, null, "取消",
                cancelButtonClickListener, null, true, null, null);
    }
    ...
    public static AlertDialog showPrompt(Context context, String message) {
        return showAlert(context, "提示", message, "确定", null, null, null, null,
                null, null, true, null, null);
    }
    /**
     * 显示一个提示框
     ...
     * @param message 提示的消息
     */
    public static AlertDialog showPrompt2(Context context, String message) {
        return showAlert(context, "提示", message, null, null, "取消", null, null,
                null, null, true, null, null);
    }
}